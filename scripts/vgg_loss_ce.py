...
parser = argparse.ArgumentParser(description='Script for training and evaluating VGG16 model with cross entropy loss')
...
# Evaluate on validation data to obtain results
