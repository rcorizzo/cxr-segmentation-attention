...
parser = argparse.ArgumentParser(description='Script for training and evaluating PVT model with cross entropy loss')
...
model= timm.create_model('pvt_v2_b2_li', pretrained=True, num_classes=args.nclass).to(device)
...
# Evaludate on validation again to obtain the report
